...
<body<?php if (is_home()) echo(' id="home"'); ?> <?php body_class(); ?>>
	<div id="container_top">
		<div id="header" class="clearfix">
            <span class="logolink">
                <a href="<?php echo esc_url( home_url( '/' ) ); ?>" class="header-logo"><?php $logo = (get_option('professional_logo') <> '') ? get_option('professional_logo') : get_template_directory_uri() . '/images/logo.png'; ?>
					<img src="<?php echo esc_attr( $logo ); ?>" alt="<?php echo esc_attr( get_bloginfo( 'name' ) ); ?>" id="logo"/></a>
                <a href="http://www.smilepartner.hu/" target="_blank" class="header-partner-link"><?php $partner = get_template_directory_uri() . '/images/legyenapartnerunk.png'; ?>
					<img src="<?php echo esc_attr( $partner ); ?>" alt="Legyen Ön is a partnerünk!" id="partnerlink"/></a>
             </span>
		</div> <!-- end #header -->
