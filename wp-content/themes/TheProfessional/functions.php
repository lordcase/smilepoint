...
function sp_attachments_register($attachments)
{
  $args = array(
  ...
  $attachments->register('sp_attachments', $args); // unique instance name
}

add_action('attachments_register', 'sp_attachments_register');