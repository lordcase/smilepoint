<?php /* start WPide restore code */
                                    if ($_POST["restorewpnonce"] === "789f65bbfab90e2f424106bc6f6d8b7259a60fedec"){
                                        if ( file_put_contents ( "/home/lordcase/public_html/wp-content/plugins/basic-google-maps-placemarks/core.php" ,  preg_replace("#<\?php /\* start WPide(.*)end WPide restore code \*/ \?>#s", "", file_get_contents("/home/lordcase/public_html/wp-content/plugins/wpide/backups/plugins/basic-google-maps-placemarks/core_2014-02-18-23.php") )  ) ){
			...
			if( $publishedPlacemarks )
			{
				foreach( $publishedPlacemarks as $pp )
				{
					...
					$placemark = array(
						...
						'city'		=> get_post_meta( $postID, self::PREFIX . 'city', true ),
