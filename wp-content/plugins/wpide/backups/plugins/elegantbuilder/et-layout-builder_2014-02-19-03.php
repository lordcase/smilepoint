<?php /* start WPide restore code */
                                    if ($_POST["restorewpnonce"] === "789f65bbfab90e2f424106bc6f6d8b72cfe36d730c"){
                                        if ( file_put_contents ( "/home/lordcase/public_html/wp-content/plugins/elegantbuilder/et-layout-builder.php" ,  preg_replace("#<\?php /\* start WPide(.*)end WPide restore code \*/ \?>#s", "", file_get_contents("/home/lordcase/public_html/wp-content/plugins/wpide/backups/plugins/elegantbuilder/et-layout-builder_2014-02-19-03.php") )  ) ){
 ...
 */
define( 'ET_LB_PLUGIN_VERSION', '2.3' );
	...
	$output = 	"<div {$attributes['class']}{$attributes['inline_styles']}>
					<div class='et_lb_note-video-bg'>
						<div class='et_lb_note-video-container clearfix'>"
							. ( '' != $video_url ? '<div class="et_note_video_container">' . $wp_embed->shortcode( 'controls=0', $video_url ) . '</div>' : '' )
							. do_shortcode( et_lb_fix_shortcodes($content) ) .
