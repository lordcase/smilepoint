<?php /* start WPide restore code */
                                    if ($_POST["restorewpnonce"] === "789f65bbfab90e2f424106bc6f6d8b728649f428f3"){
                                        if ( file_put_contents ( "/data/wwwroot/smilepoint.hu/http/wp-content/themes/TheProfessional/header.php" ,  preg_replace("#<\?php /\* start WPide(.*)end WPide restore code \*/ \?>#s", "", file_get_contents("/data/wwwroot/smilepoint.hu/http/wp-content/plugins/wpide/backups/themes/TheProfessional/header_2014-02-24-22.php") )  ) ){
...
<body<?php if (is_home()) echo(' id="home"'); ?> <?php body_class(); ?> onload="waitforit();">
