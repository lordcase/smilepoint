...
if (bgmp_requirementsMet()) {
	...
	if (class_exists('BasicGoogleMapsPlacemarks')) $bgmp = new BasicGoogleMapsPlacemarks();
}
else {
...
add_filter('http_request_args', 'bgmp_prevent_update_check', 10, 2);

function bgmp_prevent_update_check($r, $url) {
